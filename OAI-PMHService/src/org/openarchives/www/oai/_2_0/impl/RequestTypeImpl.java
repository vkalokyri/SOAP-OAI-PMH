 ...
 */
public class RequestTypeImpl extends org.apache.xmlbeans.impl.values.JavaUriHolderEx implements org.openarchives.www.oai._2_0.RequestType
{
     ...
     */
    public org.openarchives.www.oai._2_0.VerbType.Enum getVerb()
    {
        synchronized (monitor())
        {
            ...
            return (org.openarchives.www.oai._2_0.VerbType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public org.openarchives.www.oai._2_0.VerbType xgetVerb()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openarchives.www.oai._2_0.VerbType target = null;
            target = (org.openarchives.www.oai._2_0.VerbType)get_store().find_attribute_user(VERB$0);
            return target;
        }
    }
     ...
     */
    public void setVerb(org.openarchives.www.oai._2_0.VerbType.Enum verb)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetVerb(org.openarchives.www.oai._2_0.VerbType verb)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.openarchives.www.oai._2_0.VerbType)get_store().add_attribute_user(VERB$0);
            }
            target.set(verb);
        }
    }
    ...
    public org.openarchives.www.oai._2_0.IdentifierType xgetIdentifier()
    {
        synchronized (monitor())
        {
            ...
            target = (org.openarchives.www.oai._2_0.IdentifierType)get_store().find_attribute_user(IDENTIFIER$2);
            return target;
        }
    }
    ...
    public void xsetIdentifier(org.openarchives.www.oai._2_0.IdentifierType identifier)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openarchives.www.oai._2_0.IdentifierType)get_store().add_attribute_user(IDENTIFIER$2);
            }
    ...
    public org.openarchives.www.oai._2_0.MetadataPrefixType xgetMetadataPrefix()
    {
        synchronized (monitor())
        {
            ...
            target = (org.openarchives.www.oai._2_0.MetadataPrefixType)get_store().find_attribute_user(METADATAPREFIX$4);
            return target;
        }
    }
    ...
    public void xsetMetadataPrefix(org.openarchives.www.oai._2_0.MetadataPrefixType metadataPrefix)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openarchives.www.oai._2_0.MetadataPrefixType)get_store().add_attribute_user(METADATAPREFIX$4);
            }
    ...
    public org.openarchives.www.oai._2_0.UTCdatetimeType xgetFrom()
    {
        synchronized (monitor())
        {
            ...
            target = (org.openarchives.www.oai._2_0.UTCdatetimeType)get_store().find_attribute_user(FROM$6);
            return target;
        }
    }
    ...
    public void xsetFrom(org.openarchives.www.oai._2_0.UTCdatetimeType from)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openarchives.www.oai._2_0.UTCdatetimeType)get_store().add_attribute_user(FROM$6);
            }
            target.set(from);
        }
    }
    ...
    public org.openarchives.www.oai._2_0.UTCdatetimeType xgetUntil()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openarchives.www.oai._2_0.UTCdatetimeType target = null;
            target = (org.openarchives.www.oai._2_0.UTCdatetimeType)get_store().find_attribute_user(UNTIL$8);
            return target;
        }
    }
    ...
    public void xsetUntil(org.openarchives.www.oai._2_0.UTCdatetimeType until)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openarchives.www.oai._2_0.UTCdatetimeType)get_store().add_attribute_user(UNTIL$8);
            }
            target.set(until);
        }
    }
    ...
    public org.openarchives.www.oai._2_0.SetSpecType xgetSet()
    {
        synchronized (monitor())
        {
            ...
            target = (org.openarchives.www.oai._2_0.SetSpecType)get_store().find_attribute_user(SET$10);
            return target;
        }
    }
    ...
    public void xsetSet(org.openarchives.www.oai._2_0.SetSpecType set)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openarchives.www.oai._2_0.SetSpecType)get_store().add_attribute_user(SET$10);
            }
            target.set(set);
        }
    }
