 ...
 */
public class HeaderTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openarchives.www.oai._2_0.HeaderType
{
     ...
     */
    public org.openarchives.www.oai._2_0.IdentifierType xgetIdentifier()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openarchives.www.oai._2_0.IdentifierType target = null;
            target = (org.openarchives.www.oai._2_0.IdentifierType)get_store().find_element_user(IDENTIFIER$0, 0);
            return target;
        }
    }
     ...
     */
    public void xsetIdentifier(org.openarchives.www.oai._2_0.IdentifierType identifier)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.openarchives.www.oai._2_0.IdentifierType)get_store().add_element_user(IDENTIFIER$0);
            }
     ...
     */
    public org.openarchives.www.oai._2_0.UTCdatetimeType xgetDatestamp()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openarchives.www.oai._2_0.UTCdatetimeType target = null;
            target = (org.openarchives.www.oai._2_0.UTCdatetimeType)get_store().find_element_user(DATESTAMP$2, 0);
            return target;
        }
    }
     ...
     */
    public void xsetDatestamp(org.openarchives.www.oai._2_0.UTCdatetimeType datestamp)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.openarchives.www.oai._2_0.UTCdatetimeType)get_store().add_element_user(DATESTAMP$2);
            }
     ...
     */
    public org.openarchives.www.oai._2_0.SetSpecType[] xgetSetSpecArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List targetList = new java.util.ArrayList();
            get_store().find_all_element_users(SETSPEC$4, targetList);
            org.openarchives.www.oai._2_0.SetSpecType[] result = new org.openarchives.www.oai._2_0.SetSpecType[targetList.size()];
     ...
     */
    public org.openarchives.www.oai._2_0.SetSpecType xgetSetSpecArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openarchives.www.oai._2_0.SetSpecType target = null;
            target = (org.openarchives.www.oai._2_0.SetSpecType)get_store().find_element_user(SETSPEC$4, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
            return (org.openarchives.www.oai._2_0.SetSpecType)target;
        }
    }
     ...
     */
    public void xsetSetSpecArray(org.openarchives.www.oai._2_0.SetSpecType[]setSpecArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetSetSpecArray(int i, org.openarchives.www.oai._2_0.SetSpecType setSpec)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.openarchives.www.oai._2_0.SetSpecType insertNewSetSpec(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openarchives.www.oai._2_0.SetSpecType target = null;
            target = (org.openarchives.www.oai._2_0.SetSpecType)get_store().insert_element_user(SETSPEC$4, i);
            return target;
        }
    }
     ...
     */
    public org.openarchives.www.oai._2_0.SetSpecType addNewSetSpec()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openarchives.www.oai._2_0.SetSpecType target = null;
            target = (org.openarchives.www.oai._2_0.SetSpecType)get_store().add_element_user(SETSPEC$4);
            return target;
        }
    }
     ...
     */
    public org.openarchives.www.oai._2_0.StatusType.Enum getStatus()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (org.openarchives.www.oai._2_0.StatusType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public org.openarchives.www.oai._2_0.StatusType xgetStatus()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openarchives.www.oai._2_0.StatusType target = null;
            target = (org.openarchives.www.oai._2_0.StatusType)get_store().find_attribute_user(STATUS$6);
            return target;
        }
    }
     ...
     */
    public void setStatus(org.openarchives.www.oai._2_0.StatusType.Enum status)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetStatus(org.openarchives.www.oai._2_0.StatusType status)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.openarchives.www.oai._2_0.StatusType)get_store().add_attribute_user(STATUS$6);
            }
            target.set(status);
        }
    }
