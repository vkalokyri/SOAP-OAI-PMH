 ...
 */
public class ListRecordsRequestDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.netbeans.j2ee.xsd.oai_pmhservice.meta_inf.oai_pmhservice.ListRecordsRequestDocument
{
    
    public ListRecordsRequestDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName LISTRECORDSREQUEST$0 = 
        new javax.xml.namespace.QName("http://j2ee.netbeans.org/xsd/OAI-PMHservice/META-INF/OAI-PMHservice", "ListRecordsRequest");
    
    
    /**
     * Gets the "ListRecordsRequest" element
     */
    public org.netbeans.j2ee.xsd.oai_pmhservice.meta_inf.oai_pmhservice.ListRecordsRequestDocument.ListRecordsRequest getListRecordsRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.netbeans.j2ee.xsd.oai_pmhservice.meta_inf.oai_pmhservice.ListRecordsRequestDocument.ListRecordsRequest target = null;
            target = (org.netbeans.j2ee.xsd.oai_pmhservice.meta_inf.oai_pmhservice.ListRecordsRequestDocument.ListRecordsRequest)get_store().find_element_user(LISTRECORDSREQUEST$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setListRecordsRequest(org.netbeans.j2ee.xsd.oai_pmhservice.meta_inf.oai_pmhservice.ListRecordsRequestDocument.ListRecordsRequest listRecordsRequest)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.netbeans.j2ee.xsd.oai_pmhservice.meta_inf.oai_pmhservice.ListRecordsRequestDocument.ListRecordsRequest)get_store().add_element_user(LISTRECORDSREQUEST$0);
            }
            target.set(listRecordsRequest);
        }
    }
     ...
     */
    public org.netbeans.j2ee.xsd.oai_pmhservice.meta_inf.oai_pmhservice.ListRecordsRequestDocument.ListRecordsRequest addNewListRecordsRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ListRecordsRequestImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.netbeans.j2ee.xsd.oai_pmhservice.meta_inf.oai_pmhservice.ListRecordsRequestDocument.ListRecordsRequest
    {
        
        public ListRecordsRequestImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
