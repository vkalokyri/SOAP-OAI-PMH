 ...
 */
public class SetTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openarchives.www.oai._2_0.SetType
{
     ...
     */
    public org.openarchives.www.oai._2_0.SetSpecType xgetSetSpec()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openarchives.www.oai._2_0.SetSpecType target = null;
            target = (org.openarchives.www.oai._2_0.SetSpecType)get_store().find_element_user(SETSPEC$0, 0);
            return target;
        }
    }
     ...
     */
    public void xsetSetSpec(org.openarchives.www.oai._2_0.SetSpecType setSpec)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.openarchives.www.oai._2_0.SetSpecType)get_store().add_element_user(SETSPEC$0);
            }
            target.set(setSpec);
        }
    }
     ...
     */
    public org.openarchives.www.oai._2_0.DescriptionType[] getSetDescriptionArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.openarchives.www.oai._2_0.DescriptionType getSetDescriptionArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openarchives.www.oai._2_0.DescriptionType target = null;
            target = (org.openarchives.www.oai._2_0.DescriptionType)get_store().find_element_user(SETDESCRIPTION$4, i);
            if (target == null)
            {
     ...
     */
    public void setSetDescriptionArray(org.openarchives.www.oai._2_0.DescriptionType[] setDescriptionArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setSetDescriptionArray(int i, org.openarchives.www.oai._2_0.DescriptionType setDescription)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.openarchives.www.oai._2_0.DescriptionType insertNewSetDescription(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openarchives.www.oai._2_0.DescriptionType target = null;
            target = (org.openarchives.www.oai._2_0.DescriptionType)get_store().insert_element_user(SETDESCRIPTION$4, i);
            return target;
        }
    }
     ...
     */
    public org.openarchives.www.oai._2_0.DescriptionType addNewSetDescription()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openarchives.www.oai._2_0.DescriptionType target = null;
            target = (org.openarchives.www.oai._2_0.DescriptionType)get_store().add_element_user(SETDESCRIPTION$4);
            return target;
        }
    }
