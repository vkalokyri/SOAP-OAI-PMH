 ...
 */
public class ListRecordsTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openarchives.www.oai._2_0.ListRecordsType
{
     ...
     */
    public org.openarchives.www.oai._2_0.RecordType[] getRecordArray()
    {
        synchronized (monitor())
        {
            ...
            org.openarchives.www.oai._2_0.RecordType[] result = new org.openarchives.www.oai._2_0.RecordType[targetList.size()];
     ...
     */
    public org.openarchives.www.oai._2_0.RecordType getRecordArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openarchives.www.oai._2_0.RecordType target = null;
            target = (org.openarchives.www.oai._2_0.RecordType)get_store().find_element_user(RECORD$0, i);
            if (target == null)
            {
     ...
     */
    public void setRecordArray(org.openarchives.www.oai._2_0.RecordType[] recordArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setRecordArray(int i, org.openarchives.www.oai._2_0.RecordType record)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.openarchives.www.oai._2_0.RecordType insertNewRecord(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openarchives.www.oai._2_0.RecordType target = null;
            target = (org.openarchives.www.oai._2_0.RecordType)get_store().insert_element_user(RECORD$0, i);
            return target;
        }
    }
