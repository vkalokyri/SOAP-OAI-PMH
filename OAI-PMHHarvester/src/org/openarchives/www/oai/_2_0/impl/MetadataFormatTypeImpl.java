 ...
 */
public class MetadataFormatTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openarchives.www.oai._2_0.MetadataFormatType
{
    ...
    public org.openarchives.www.oai._2_0.MetadataPrefixType xgetMetadataPrefix()
    {
        synchronized (monitor())
        {
            ...
            target = (org.openarchives.www.oai._2_0.MetadataPrefixType)get_store().find_element_user(METADATAPREFIX$0, 0);
            return target;
        }
    }
    ...
    public void xsetMetadataPrefix(org.openarchives.www.oai._2_0.MetadataPrefixType metadataPrefix)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openarchives.www.oai._2_0.MetadataPrefixType)get_store().add_element_user(METADATAPREFIX$0);
            }
