 ...
 */
public class ListIdentifiersTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openarchives.www.oai._2_0.ListIdentifiersType
{
     ...
     */
    public org.openarchives.www.oai._2_0.HeaderType[] getHeaderArray()
    {
        synchronized (monitor())
        {
            ...
            org.openarchives.www.oai._2_0.HeaderType[] result = new org.openarchives.www.oai._2_0.HeaderType[targetList.size()];
     ...
     */
    public org.openarchives.www.oai._2_0.HeaderType getHeaderArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openarchives.www.oai._2_0.HeaderType target = null;
            target = (org.openarchives.www.oai._2_0.HeaderType)get_store().find_element_user(HEADER$0, i);
            if (target == null)
            {
     ...
     */
    public void setHeaderArray(org.openarchives.www.oai._2_0.HeaderType[] headerArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setHeaderArray(int i, org.openarchives.www.oai._2_0.HeaderType header)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.openarchives.www.oai._2_0.HeaderType insertNewHeader(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openarchives.www.oai._2_0.HeaderType target = null;
            target = (org.openarchives.www.oai._2_0.HeaderType)get_store().insert_element_user(HEADER$0, i);
            return target;
        }
    }
